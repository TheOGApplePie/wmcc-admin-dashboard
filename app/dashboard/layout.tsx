            ...
            <ul className="menu w-full grow">
                ...
                <Link href="/">
                  ...
                  >
                    <svg width={40} height={40} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                      <path fill="none" stroke="#000" strokeWidth="2" strokeMiterlimit="10" d="M3 17 16 4l13 13" />
                      <path fill="none" stroke="#000" strokeWidth="2" strokeMiterlimit="10" d="M6 14v13h7V17h6v10h7V14" />
                    </svg>
              ...
              <li>
                <Link href="/dashboard/posts">
                  <button
                    className="is-drawer-close:tooltip is-drawer-close:tooltip-right hover:cursor-pointer"
                    data-tip="Social Posts"
                  >
                    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <line x1="22" y1="2" x2="11" y2="13" stroke="#000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      <polygon points="22 2 15 22 11 13 2 9 22 2" stroke="#000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
                    </svg>
                    <span className="p-3 is-drawer-close:hidden">Social Posts</span>
                  </button>
                </Link>
              </li>
              ...
              <li>
                <Link href="/dashboard/community-feedback">
                  ...
                  >
                    ...
                    <span className="p-3 is-drawer-close:hidden">Community Feedback</span>
                  </button>
                </Link>
              </li>
              ...
              <li>
                <Link href="/dashboard/notifications">
                  ...
                  >
                    ...
                    <span className="p-3 is-drawer-close:hidden">Notifications</span>
                  </button>
                </Link>
              </li>
